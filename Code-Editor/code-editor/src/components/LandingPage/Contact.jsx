    ...
    return (
        <Box id="contact">
            <div className="flex gap-4 items-center justify-center">
                <Link to="https://github.com/shrutii-pandey"><FaGithub className='text-2xl ' /></Link>
                <Link to="https://www.linkedin.com/in/shruti-pandey"><FaLinkedin className='text-2xl ' /></Link>
                <Link to="mailto:shrutipandeyobra@gmail.com"><CiMail className='text-2xl ' /></Link>
            </div>
